 ...
 * </ul>
 * <p>
 * There are alternate flows when the direct lua-to-Java bytecode compiling {@link io.github.taoguan.luaj.luajc.LuaJC} is used.
 * <ul>
 * <li>compile lua to lua bytecode using {@link Compiler} or load precompiled code using {@link Undumper}
 * <li>convert lua bytecode to equivalent Java bytecode using {@link io.github.taoguan.luaj.luajc.LuaJC} that implements {@link Loader} directly
 * </ul>
 * 
 * <h3>Java Field</h3>
