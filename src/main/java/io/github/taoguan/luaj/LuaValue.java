 ...
 * See {@link io.github.taoguan.luaj.lib.jse.JsePlatform}
 * <p>
...
public class LuaValue extends Varargs {
	 ...
	 * or {@link LuaValue} if metatag processing occurs
	 * @throws LuaError if either operand is not a number or string convertible to number,
	 * and neither has the {@link #IDIV} metatag defined
	 * @see #arithmt(LuaValue, LuaValue)
	 */
	 ...
	 * @see #div(LuaValue)
	 */
	public LuaValue   idiv( double rhs )        { return aritherror("div"); }
	 ...
	 * @see #div(LuaValue)
	 */
	public LuaValue   idiv( int rhs )        { return aritherror("div"); }
	...
	public LuaValue band(LuaValue rhs){
		int value = checkint();
		int right = rhs.checkint();
		return LuaValue.valueOf(value & right);
	}
	...
	public LuaValue shl(LuaValue rhs){
		int value = checkint();
		int right = rhs.checkint();
		return LuaValue.valueOf(MathLib.shiftLeft(value, right));
	}

	public LuaValue shr(LuaValue rhs){
		int value = checkint();
		int right = rhs.checkint();
		return LuaValue.valueOf(MathLib.shiftRight(value, right));
	}
