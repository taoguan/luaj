...
/** Class to dump a {@link io.github.taoguan.luaj.Prototype} into an output stream, as part of compiling.
 * <p>
 * Generally, this class is not used directly, but rather indirectly via a command 
 * line interface tool such as.
 * <p>
 ...
 * } </pre>
 * 
 * The {@link io.github.taoguan.luaj.LoadState} may be used directly to undump these bytes:
 * <pre> {@code
...
public class DumpState {
	...
	void dumpString(io.github.taoguan.luaj.LuaString s) throws IOException {
	...
	void dumpCode( final io.github.taoguan.luaj.Prototype f ) throws IOException {
	...
	void dumpConstants(final io.github.taoguan.luaj.Prototype f) throws IOException {
		final io.github.taoguan.luaj.LuaValue[] k = f.k;
		int i, n = k.length;
		dumpInt(n);
		for (i = 0; i < n; i++) {
			final io.github.taoguan.luaj.LuaValue o = k[i];
			switch ( o.type() ) {
			case io.github.taoguan.luaj.LuaValue.TNIL:
				writer.write(io.github.taoguan.luaj.LuaValue.TNIL);
				break;
			case io.github.taoguan.luaj.LuaValue.TBOOLEAN:
				writer.write(io.github.taoguan.luaj.LuaValue.TBOOLEAN);
				dumpChar(o.toboolean() ? 1 : 0);
				break;
			case io.github.taoguan.luaj.LuaValue.TNUMBER:
				switch (NUMBER_FORMAT) {
				case NUMBER_FORMAT_FLOATS_OR_DOUBLES:
					writer.write(io.github.taoguan.luaj.LuaValue.TNUMBER);
				...
				case NUMBER_FORMAT_NUM_PATCH_INT32:
					if ( o.isint() ) {
						writer.write(io.github.taoguan.luaj.LuaValue.TINT);
						dumpInt(o.toint());
					} else {
						writer.write(io.github.taoguan.luaj.LuaValue.TNUMBER);
						dumpDouble(o.todouble());
			...
			case io.github.taoguan.luaj.LuaValue.TSTRING:
				writer.write(io.github.taoguan.luaj.LuaValue.TSTRING);
				dumpString((io.github.taoguan.luaj.LuaString)o);
				break;
			default:
	...
	void dumpUpvalues(final io.github.taoguan.luaj.Prototype f) throws IOException {
	...
	void dumpDebug(final io.github.taoguan.luaj.Prototype f) throws IOException {
		int i, n;
		if (strip)
			dumpInt(0);
		else
		...
		dumpInt(n);
		for (i = 0; i < n; i++) {
			io.github.taoguan.luaj.LocVars lvi = f.locvars[i];
	...
	void dumpFunction(final io.github.taoguan.luaj.Prototype f) throws IOException {
	...
	void dumpHeader() throws IOException {
		writer.write( io.github.taoguan.luaj.LoadState.LUA_SIGNATURE );
		writer.write( io.github.taoguan.luaj.LoadState.LUAC_VERSION );
		writer.write( io.github.taoguan.luaj.LoadState.LUAC_FORMAT );
		...
		writer.write( io.github.taoguan.luaj.LoadState.LUAC_TAIL );
	}

	/*
	** dump Lua function as precompiled chunk
	*/
	public static int dump(io.github.taoguan.luaj.Prototype f, OutputStream w, boolean strip ) throws IOException {
	 ...
	 */
	public static int dump(io.github.taoguan.luaj.Prototype f, OutputStream w, boolean stripDebug, int numberFormat, boolean littleendian) throws IOException {
		switch ( numberFormat ) {
		case NUMBER_FORMAT_FLOATS_OR_DOUBLES:
		case NUMBER_FORMAT_INTS_ONLY:
		case NUMBER_FORMAT_NUM_PATCH_INT32:
