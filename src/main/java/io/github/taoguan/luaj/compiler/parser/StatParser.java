...
import static io.github.taoguan.luaj.compiler.lexer.TokenKind.TOKEN_KW_BREAK;
import static io.github.taoguan.luaj.compiler.lexer.TokenKind.TOKEN_KW_CONTINUE;
import static io.github.taoguan.luaj.compiler.lexer.TokenKind.TOKEN_KW_DO;
import static io.github.taoguan.luaj.compiler.lexer.TokenKind.TOKEN_KW_ELSE;
import static io.github.taoguan.luaj.compiler.lexer.TokenKind.TOKEN_KW_ELSEIF;
import static io.github.taoguan.luaj.compiler.lexer.TokenKind.TOKEN_KW_END;
import static io.github.taoguan.luaj.compiler.lexer.TokenKind.TOKEN_KW_FOR;
import static io.github.taoguan.luaj.compiler.lexer.TokenKind.TOKEN_KW_FUNCTION;
import static io.github.taoguan.luaj.compiler.lexer.TokenKind.TOKEN_KW_GOTO;
import static io.github.taoguan.luaj.compiler.lexer.TokenKind.TOKEN_KW_IF;
import static io.github.taoguan.luaj.compiler.lexer.TokenKind.TOKEN_KW_IN;
import static io.github.taoguan.luaj.compiler.lexer.TokenKind.TOKEN_KW_LOCAL;
import static io.github.taoguan.luaj.compiler.lexer.TokenKind.TOKEN_KW_REPEAT;
import static io.github.taoguan.luaj.compiler.lexer.TokenKind.TOKEN_KW_THEN;
import static io.github.taoguan.luaj.compiler.lexer.TokenKind.TOKEN_KW_UNTIL;
import static io.github.taoguan.luaj.compiler.lexer.TokenKind.TOKEN_KW_WHILE;
import static io.github.taoguan.luaj.compiler.lexer.TokenKind.TOKEN_OP_ASSIGN;
import static io.github.taoguan.luaj.compiler.lexer.TokenKind.TOKEN_SEP_COLON;
import static io.github.taoguan.luaj.compiler.lexer.TokenKind.TOKEN_SEP_COMMA;
import static io.github.taoguan.luaj.compiler.lexer.TokenKind.TOKEN_SEP_DOT;
import static io.github.taoguan.luaj.compiler.lexer.TokenKind.TOKEN_SEP_LABEL;
...
import static io.github.taoguan.luaj.compiler.parser.ExpParser.parseExp;
import static io.github.taoguan.luaj.compiler.parser.ExpParser.parseExpList;
import static io.github.taoguan.luaj.compiler.parser.ExpParser.parseFuncDefExp;
    ...
    */
    static Stat parseStat(Lexer lexer) {
        switch (lexer.LookAhead()) {
            ...
            case TOKEN_KW_CONTINUE: return parseContinueStat(lexer);
    ...
    // continue
    private static ContinueStat parseContinueStat(Lexer lexer) {
        lexer.nextTokenOfKind(TOKEN_KW_CONTINUE);
        return new ContinueStat(lexer.line());
    }
    ...
    private static LabelStat parseLabelStat(Lexer lexer) {
        ...
        lexer.nextTokenOfKind(TOKEN_SEP_LABEL);          // ::
        return new LabelStat(name, lexer.line());
    }
    ...
    private static GotoStat parseGotoStat(Lexer lexer) {
        ...
        String name = lexer.nextIdentifier().getValue(); // name
        return new GotoStat(name, lexer.line());
    }
