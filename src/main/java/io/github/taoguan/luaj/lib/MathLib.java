 ...
 * use {@link io.github.taoguan.luaj.lib.jse.JseMathLib}.
 ...
 * {@link io.github.taoguan.luaj.lib.jse.JsePlatform#standardGlobals()} or
 * <pre> {@code
 * Globals globals = JsePlatform.standardGlobals();
 * System.out.println( globals.get("math").get("sqrt").call( LuaValue.valueOf(2) ) );
 * } </pre>
 * When using {@link io.github.taoguan.luaj.lib.jse.JsePlatform} as in this example,
 * the subclass {@link io.github.taoguan.luaj.lib.jse.JseMathLib} will
