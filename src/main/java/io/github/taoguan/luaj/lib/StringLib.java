...
import io.github.taoguan.luaj.compiler.DumpState;
...
public class StringLib extends TwoArgFunction {
	 ...
	 * {@link #call(io.github.taoguan.luaj.LuaValue, io.github.taoguan.luaj.LuaValue)}. */
	public StringLib() {
	}
	 ...
	 * {@link io.github.taoguan.luaj.LuaString#s_metatable} table should probably be made read-only.
