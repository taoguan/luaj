 ...
 * <li>{@link LuaValue#listOf(LuaValue[], io.github.taoguan.luaj.Varargs)}</li>
 * <li>{@link LuaValue#tableOf(LuaValue[])}</li>
 * <li>{@link LuaValue#tableOf(LuaValue[], LuaValue[], io.github.taoguan.luaj.Varargs)}</li>
 * </ul>
...
public class CoerceJavaToLua {
	...
	private static final class StringCoercion implements Coercion {
		public LuaValue coerce( Object javaValue ) {
			return io.github.taoguan.luaj.LuaString.valueOf( javaValue.toString() );
		}
	}
	 ...
	 * {@code String} and {@code byte[]} will become {@link io.github.taoguan.luaj.LuaString};
